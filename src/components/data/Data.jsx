...
export const facilities = [
  {
    ...
    items: [
      ...
      { icon: <i className="fa fa-home text-primary me-2"></i>, name: "Family Cottage ideal for small families or groups" },
      ...
      { icon: <i className="fa fa-home text-primary me-2"></i>, name: "Comfortable furnishing and modern décor" },
      { icon: <i className="fa fa-wind text-primary me-2"></i>, name: "Air Conditioning" },
      { icon: <i className="fa fa-ice-cream text-primary me-2"></i>, name: "Complimentary drinking water (replenished daily)" },
  ...
  },
  {
    ...
    items: [
      { icon: <i className="fa fa-bell text-primary me-2"></i>, name: "Banquet Hall for dinners, gatherings & celebrations" },
  ...
  },
  {
    ...
    icon: <i className="fa fa-concierge-bell fa-2x text-primary"></i>,
    items: [
      { icon: <i className="fa fa-home text-primary me-2"></i>, name: "In-house Laundry" },
      { icon: <i className="fa fa-crown text-primary me-2"></i>, name: "Huge Parking Space for cars & buses" },
      { icon: <i className="fa fa-crown text-primary me-2"></i>, name: "Drivers' Accommodation (at extra cost)" },
